...
def modBFS3(start, goal, size):  # pass in strings!! (and the size of the string)
    fringe = deque()
    visited = set()
    fringe.append((start, 0))
    visited.add(start)
...
if __name__ == "__main__":
    ...
    # for i in modBFS3("8672543.1", "12345678.", 3)[-1].values():
    #     print(i)

    for i in modBFS3("64785.321", "12345678.", 3)[-1].values():
        print(i)
